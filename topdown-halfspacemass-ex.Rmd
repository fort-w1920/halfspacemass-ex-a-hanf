...
![recreation of Figure 3 using my own code](fig3.png)
Check Figure 5: 
...
```
Mein Ergebnis hier:
![recreation of Figure 5 using my own code](fig5.png)
Hier noch eine 3-dimensionale Visualisierung mit plotly:
![3-dimensional half space depth](3d.png)
